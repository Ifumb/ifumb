...
/** The owner records a union between one or two members of the tree. */
export class CreateUnionUseCase {
  constructor(private readonly deps: CreateUnionDeps) {}

  async execute(input: CreateUnionInput): Promise<Result<{ unionId: string }, CreateUnionError>> {
